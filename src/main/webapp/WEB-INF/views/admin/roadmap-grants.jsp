...
<%
    ...
    Long selectedUserId = (Long) request.getAttribute("selectedUserId");
...
<nav class="navbar app-navbar">
    <div class="container py-2">
        ...
        <div class="d-flex gap-2">
            ...
            <a class="btn btn-outline-secondary" href="${pageContext.request.contextPath}/admin/roadmap-management">CRUD roadmap</a>
...
<div class="container py-4">
    <div class="app-section p-4">
        ...
        <form method="get" action="${pageContext.request.contextPath}/admin/roadmap-grants" class="row g-2 mb-3">
            <div class="col-md-8">
                <select class="form-select" name="userId" onchange="this.form.submit()" required>
                    <option value="">-- Chon tai khoan --</option>
                    <% if (learners != null) {
                           for (UserAccount learner : learners) {
                               Long learnerUserId = learner.getUserID();
                               boolean selected = selectedUserId != null && selectedUserId.equals(learnerUserId);
                    %>
                        <option value="<%= learnerUserId %>" <%= selected ? "selected" : "" %>>
